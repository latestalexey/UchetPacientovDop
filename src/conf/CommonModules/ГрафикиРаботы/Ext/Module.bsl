...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ГрафикиРаботы.СоздатьКалендарьПятидневкаРеспубликиБеларусь";
...
Процедура СоздатьКалендарьПятидневкаРеспубликиБеларусь() Экспорт
	
	ПроизводственныйКалендарь = КалендарныеГрафики.ПроизводственныйКалендарьРеспубликиБеларусь();
	Если ПроизводственныйКалендарь = Неопределено Тогда 
		Возврат;
	КонецЕсли;
