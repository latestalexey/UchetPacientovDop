...
Функция ПроизводственныйКалендарьРеспубликиБеларусь() Экспорт
		
	ПроизводственныйКалендарь = Справочники.ПроизводственныеКалендари.НайтиПоКоду("РБ");
